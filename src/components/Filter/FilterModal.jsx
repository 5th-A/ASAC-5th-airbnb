  ...
  return (
    <section>
      <div className='fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50'>
        <div className='w-[45%] max-h-[90vh] border-b-8 bg-white rounded-lg flex flex-col'>
          {/* 모달 상단 - 필터 제목 */}
          ...
          {/* 모달 하단 - 버튼 영역 */}
          <footer className='flex justify-between items-center border-t-2 border-solid border-gray-200 p-3'>
            <button
