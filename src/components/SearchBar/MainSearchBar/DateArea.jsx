  ...
  return (
    <>
      <div className='flex justify-between items-center'>
        <div
          className={`Frame21 h-[64px] px-6 py-3.5 flex justify-between items-center gap-1 hover:bg-gray-200 hover:rounded-full cursor-pointer ${isActiveCheckin ? 'bg-white rounded-full' : 'bg-transparent'}`}
        ...
        <div
          className={`Line11 min-h-8 w-0 border border-neutral-300 border-solid group-hover:border-transparent ${isActiveCheckin ? 'border-transparent' : ''}`}
        ></div>
        <div
        ...
        <div
          className={`Line11 min-h-8 w-0 border border-neutral-300 border-solid group-hover:border-transparent ${isActiveCheckout ? 'border-transparent' : ''}`}
        ></div>
      </div>
    </>
  )
