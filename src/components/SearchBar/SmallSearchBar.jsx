const Line = () => (
  ...
  const SmallWhereArea = () => (
    <>
      <div className="Frame24 w-2/6 h-[48px]  rounded-tl-[500px] rounded-bl-[500px] flex flex-col justify-center items-center gap-1 inline-flex hover:bg-gray-200 hover:rounded-full">
        <div className="SearchDestinations text-neutral-500 text-sm font-normal font-['SF Pro'] ">어디든지</div>
      </div>
      <Line />
    </>
  );
  ...
  const CheckInArea = () => (
    <>
      <div className="Frame21 w-2/6 h-[48px]  flex-col justify-center items-center gap-1 inline-flex hover:bg-gray-200 hover:rounded-full">
        <div className="AddDates text-neutral-500 text-sm font-normal font-['SF Pro']">언제든 일주일</div>
      </div>
      <Line />
    </>
  );
  ...
  const SmallSearchBarWrap = ({ children }) => (
    <div className="SearchBarWrap w-1/3 h-[43px] rounded-[500px] border border-neutral-300 justify-center items-center gap-px inline-flex border-solid whitespace-nowrap">
      {children}
    </div>
  );
